...
### Changed
- **BLB default behavior** - All blips start collapsed; inline `[+]` navigates into subblip view
...
- **EDITOR.md** - Updated BLB/toolbar/inline-comment parity notes to reflect current implementation status
- **EDITOR_TOOLBAR_PARITY.md** - Updated topic toolbar status and topic render unification to reflect current implementation
- **QUICKSTART.md** - Added FEAT_ALL note for parity/smokes and linked to handoff/restart docs
- **TESTING_GUIDE.md** - Clarified FEAT_ALL/EDITOR_ENABLE + real-auth requirement for core feature testing
- **CLAUDE.md** - Updated run/verify and backup notes for FEAT_ALL/EDITOR_ENABLE and current backup script
...
- **BLB snapshots** - Refreshed BLB snapshot set under `snapshots/blb/1770162413598-*` after Playwright verification
...
- **Topic pane styling** - Removed unread yellow row background and flattened topic container/toolbar to match legacy layout
- **Docs** - Added `docs/TECH_STACK_OLD_VS_NEW.md` with legacy vs modern stack overview
