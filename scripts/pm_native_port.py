...
PHASES: list[Phase] = [
    ...
    Phase(1, 52, "Spike: parser + renderer + BlipThread (static render)",
          ...
          3, [
              ...
              Deliverable("vitest tests — 8/8 passing (parser smoke)", True, "b06d4d30"),
              Deliverable("serializer.ts — ContentArray → HTML inverse"),
              Deliverable("Spike harness HTML rendering depth-10 fractal from JSON fixture"),
              Deliverable("Pixel-match against rizzoma.com depth-10 reference screenshot"),
