...
PHASES: list[Phase] = [
    ...
    Phase(2, 53, "BlipView lifecycle + TipTap edit-mode + Ctrl+Enter",
          ...
          4, [
              ...
              Deliverable("wave-view.ts — full port of wave/view.coffee (registry + events + DOM helpers)", True),
              Deliverable("NativeWaveView.tsx — thin React wrapper behind feature flag", True),
