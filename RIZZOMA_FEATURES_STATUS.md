...
| Functionality | Status | Original Rizzoma | New Rizzoma |
|---|---|---|---|
| Fresh topic/reply/inline body is always a bullet list | **Fix candidate; public blocker** | Every new blip starts as `<ul><li>` | Public failure measured 18 P / 0 UL / 0 LI after reload; durable editor/Yjs/API repair passes 57 focused and 672 full-suite tests, pending real-control deploy acceptance |
