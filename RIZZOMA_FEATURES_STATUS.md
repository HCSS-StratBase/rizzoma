...
- **Screenshot evidence** - `screenshots/260424-015008-feature-sweep/042-real-time-cursor-and-typing-indicator-visible.png` shows a second authenticated editor producing remote cursor and typing UI in public production.
...
- **Full-render scale-up**: 100-blip public-prod full-render baseline now passes; rerun at 500/1000 blips, compare against lite mode, and investigate optional absolute-TTF drift plus broken external avatar placeholders visible in screenshots.
- **Visual sweep hardening**: `npm run visual:sweep` and `npm run visual:coverage` now produce a broad fresh feature sweep plus a row-level coverage matrix for all 161 screenshot-valid rows. The current matrix has zero screenshot gaps; next hardening is product quality, especially avatar fallbacks and mobile toolbar crowding.
...
| Live cursors (Yjs awareness, user colors) | Done | [orig](screenshots/rizzoma-live/feature/rizzoma-core-features/rizzoma-presence.png) | [new](screenshots/260424-015008-feature-sweep/042-real-time-cursor-and-typing-indicator-visible.png) |
| Typing indicators | Done | — | [new](screenshots/260424-015008-feature-sweep/042-real-time-cursor-and-typing-indicator-visible.png) |
