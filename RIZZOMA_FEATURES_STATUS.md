...
- **Mobile device validation**: PWA infrastructure, runtime tests, and physical Pixel 9 Pro XL / Chrome validation are complete for the branch. Public VPS redeploy smoke and iPhone Safari are still separate risks.
