...
- Visual residual from 2026-04-24 public-prod screenshots: mobile gesture, BottomSheet, touch-target/PWA, and offline behavior now have focused runtime tests; physical Pixel 9 Pro XL / Chrome closes the last branch-matrix row. Public VPS freshness was corrected by deploying `feature/rizzoma-core-features` commit `69d6a8a9`; public Android Chrome cursor-inline proof lives in `screenshots/260424-real-device-pixel9proxl-public/`. Boundary: iPhone Safari remains untested.
