...
Last Updated: 2026-02-04 (BLB toolbar visibility tied to expanded state; BLB snapshots refreshed)
...
- Read-only blip toolbar now includes Collapse/Expand buttons for legacy parity; toolbar renders only for expanded blips.
