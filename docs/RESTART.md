...
- `docs/HANDOFF.md` reflects `feature/native-fractal-port` as of 2026-05-10. Earlier `feature/rizzoma-core-features` state preserved in HANDOFF.md "Previous work" section.
